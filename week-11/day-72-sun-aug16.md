...
**Re-solve from memory:** [Rotting Oranges](https://leetcode.com/problems/rotting-oranges)
NeetCode: `youtu.be/y704fEOx0s0`
...
**LangGraph: watch Lessons 3-4**
**Resource:** learn.deeplearning.ai/courses/ai-agents-in-langgraph

Tool use, memory, human-in-the-loop. How production agents handle errors.
...
**Project 3: plan architecture**


Sketch: which MCP tools? What external API? What does the agent do? Write in your notebook.
...
2. Write tomorrow's problem in your notebook: **Combination Sum**
