...
**Re-solve from memory:** [Partition Equal Subset](https://leetcode.com/problems/partition-equal-subset-sum)
NeetCode: `youtu.be/IlEsdxuD4lY`
...
**LangSmith: setup tracing on Project 3**
**Resource:** smith.langchain.com

Every agent step traced. Screenshot the dashboard — goes in README.
...
2. Write tomorrow's problem in your notebook: **Insert Interval**
