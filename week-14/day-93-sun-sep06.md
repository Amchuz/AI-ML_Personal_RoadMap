# Sunday, 06 September 2026 · Day 93
...
**Re-solve from memory:** [Decode Ways](https://leetcode.com/problems/decode-ways)
NeetCode: `youtu.be/6aEyTjOwlJU`
...
**Anthropic MCP Coursera: Lessons 1-2**
**Resource:** coursera.org/learn/introduction-to-model-context-protocol

MCP architecture, tools vs resources vs prompts. The 3 MCP primitives.
...
**Project 3: add error handling + retries**
**Open:** colab.research.google.com

pip install tenacity. Wrap every MCP tool call with @retry decorator.
...
2. Write tomorrow's problem in your notebook: **Partition Equal Subset**
