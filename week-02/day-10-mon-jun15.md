...
**Problem:** [Encode & Decode Strings](https://leetcode.com/problems/encode-and-decode-strings)
**Pattern:** Arrays & Hashmaps

### Steps
1. Open LeetCode: `leetcode.com/problems/encode-and-decode-strings`
2. Set a **25 min timer** — attempt alone, no hints
3. After timer: watch NeetCode explanation → `youtu.be/B1k_sxOSgv8`
