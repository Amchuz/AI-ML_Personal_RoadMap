# Sunday, 01 November 2026 · Day 149
...
**Watch Exponent: ML System Design walkthrough 1**
**Resource:** tryexponent.com/courses/ml

Structure: clarify → estimate → design → deep-dive → trade-offs. Note the pacing.
...
**Customise STAR stories for Google (Googliness)**


Pick your 5 strongest STAR stories. Reframe each with Googliness language.
