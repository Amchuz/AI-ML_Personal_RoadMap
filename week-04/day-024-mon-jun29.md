...
### Steps
1. Open NeetCode → find **#24 Merge Two Sorted Lists** → neetcode.io/practice
2. Set **25 min timer** — attempt alone, no hints
3. After timer: watch NeetCode video explanation on the same page
4. Submit on LeetCode to build your profile → leetcode.com/problems/merge-two-sorted-lists
